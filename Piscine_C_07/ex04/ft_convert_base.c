...
/*                                                +#+#+#+#+#+   +#+           */
/*   Created: 2022/12/03 17:16:55 by abuonomo          #+#    #+#             */
/*   Updated: 2022/12/03 17:16:59 by abuonomo         ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
...
char	*ft_convert_base(char *nbr, char *base_from, char *base_to)
{
	...
	fnbr = malloc(sizeof(char) * (lenght_nbrf + 1));
	if (!fnbr)
		return (0);
	ft_putnbr_base_v2(mednbr, base_to, fnbr);
	fnbr[lenght_nbrf] = '\0';
	return (fnbr);
}
